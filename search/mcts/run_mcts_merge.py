...
if __name__ == '__main__':
    ...
    if CONTINUE:    
        ...
        output_fpath = f"{dataset_type}_{dataset_name}_mcts_merge_rb{config.root_budget}_nb{config.node_budget}_c{config.c}_r{config.n_rollouts}_md{config.max_depth}_mt{config.min_terminals}_d{config.d}.pkl"
