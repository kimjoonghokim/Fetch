...
def evaluate_ssdp_results(results_file: str, output_file: str = None):
    ...
    for i, problem in enumerate(problems):
        ...
        if best_terminal:
            ...
            result = {
                ...
                "completion_tokens": problem.total_completion_tokens
            }
        else:
            result = {
                "problem_id": i,
        ...
        total_prompt_tokens += problem.total_prompt_tokens
    ...
    print(f"Average runtime per problem: {total_runtime / total_problems:.2f} seconds")
    print(f"\n--- Token Usage ---")
        ...
        with open(output_file, "w") as f:
            json.dump({
                "summary": {
                    ...
                    "average_runtime_seconds": total_runtime / total_problems if total_problems > 0 else 0,
